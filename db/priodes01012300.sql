...
INSERT INTO `alternatif` (`id_alternatif`, `masalah`, `potensi`, `alternatif`, `padukuhan`, `rt`, `panjang`, `lebar`, `tinggi`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Jalan Madusari Rusak Berat', 'Tenaga', 'Rehabilitasi Jalan Madusari', 1, 9, 100, 3, 0, '2023-01-01 21:11:47', '2023-01-01 21:11:47', NULL),
(2, 'Pengutusan Bayi Tidak Valid', 'KAder', 'Pengadaan Alat Ukur', 2, 1, 0, 0, 0, '2023-01-01 21:12:47', '2023-01-01 21:12:47', NULL);
...
--
ALTER TABLE `padukuhan`
  MODIFY `id_padukuhan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
